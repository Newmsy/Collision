...
def MakeCapillaries(Number):
    ...
    for i in range(1,Number):
        Boundary = [0,i*Step-3]
        BoundaryLim = [[60,80],[i*Step-2.999999,i*Step-3.0000001]]
...
Boundary1 = [1e10,-100e10]
BoundaryLims1 = [[99.9999,100.00001],[-3.00001,3.00001]]

Boundary2 = [0,3]
BoundaryLims2 = [[60,100.00001],[2.999999,3.0000001]]

Boundary3 = [0,-3]
BoundaryLims3 = [[60,100.00001],[-2.99999,-3.0000001]]
...
FunctCapBounds,FunctCapLims=MakeCapillaries(5)
...
with open('5CapillCollY.txt',mode='a') as FileWall:
    FileWall.truncate(0)
    YHistHold=[]
